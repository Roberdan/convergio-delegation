...
[![CI](https://github.com/Roberdan/convergio-delegation/actions/workflows/ci.yml/badge.svg)](https://github.com/Roberdan/convergio-delegation/actions/workflows/ci.yml)
[![License: Convergio Community](https://img.shields.io/badge/license-Convergio%20Community-blue)](https://github.com/Roberdan/convergio-delegation/blob/main/LICENSE)
[![Rust](https://img.shields.io/badge/rust-stable-orange)](https://www.rust-lang.org/)
[![Zero Warnings](https://img.shields.io/badge/warnings-0-brightgreen)](#)

Delegation orchestrator for the Convergio mesh — copy files, spawn remote agents, monitor execution, sync results back, and notify on completion.
...
```mermaid
graph LR
    CRATE[convergio-delegation] --> SDK[convergio-sdk]
    SDK --> T[types]
    SDK --> TEL[telemetry]
    SDK --> DB[db]
    SDK --> SEC[security]
...
```toml
[dependencies]
convergio-delegation = { git = "https://github.com/Roberdan/convergio-delegation", tag = "v0.1.0" }
```
